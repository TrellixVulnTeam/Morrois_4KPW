...
path('item/<str:id>/',views.item_view, name='item'),
...
path('d3sparql/', views.d3sparql_view, name='d3sparql'),
...
path('d3sparql-treemap/', views.treemap_view, name='d3sparql-treemap'),
path('d3sparql-dendrogram/', views.dendrogram_view, name='d3sparql-dendrogram'),
path('d3sparql-sunburst/', views.sunburst_view, name='d3sparql-sunburst'),
path('d3sparql-treemapzoom/', views.treemapzoom_view, name='d3sparql-treemapzoom')
]
